word_choices = {
    'PZAZZ', 'JAZZY', 'BUZZY', 'FUZZY', 'FIZZY', 'WHIZZ', 'DIZZY', 'FRIZZ', 'MEZZO', 'PIZZA', 'WIZZO', 'JACKY',
...
feedbacks = {l1 + l2 + l3 + l4 + l5 for l1 in 'gyb' for l2 in 'gyb' for l3 in 'gyb' for l4 in 'gyb' for l5 in 'gyb'}